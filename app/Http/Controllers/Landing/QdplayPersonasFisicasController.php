...
class QdplayPersonasFisicasController extends Controller
{
    ...
    {
        return view('landings.register-qdplay-personas-fisicas');
    }
    ...
    public function store(Request $request)
    {
        $params = $request->validate([
            ...
            'mail' => 'required|email|min:1|max:255',
        ...
        $lead->interests = 'QD Play personas fisicas';
        $lead->form = 'registro-qdplay-personas-fisicas';
