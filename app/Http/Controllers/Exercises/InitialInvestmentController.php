...
class InitialInvestmentController extends BaseController
{
    ...
    public function edit(Request  $request)
    {
        ...
        return view('exercises.initialinvestment.edit')->with([
            'answers' => $answers ?? []
        ]);
    }
    ...
    {
        $user = $request->user();
        $redirect = redirect()->route('exercises.initialinvestment.edit');
