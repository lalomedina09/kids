...
$(document).ready(function() {
    ...
    function r() {
        ...
        function h() {
            ...
            r && r != e && (i = Math.round(o / (e - r) * 1e3), a.push(i), 30 < a.length && a.splice(0, 1), o = 0, $("#sparkline5").sparkline(a, { tooltipSuffix: " pixels per second", type: "line", width: "100%", height: "165", chartRangeMax: 50, lineColor: "#f9c851", fillColor: "rgba(249, 200, 81, 0.3)", highlightLineColor: "rgba(24,147,126,.1)", highlightSpotColor: "rgba(24,147,126,.2)" })), r = e, setTimeout(h, 500)
        }
        $("html").mousemove(function(i) {
            var e = i.pageX,
                i = i.pageY; - 1 < l && (o += Math.max(Math.abs(e - l), Math.abs(i - t))), l = e, t = i
        }), setTimeout(h, 500)
    }
    var l;
    e(), r(), $(window).resize(function(i) { clearTimeout(l), l = setTimeout(function() { e(), r() }, 300) })
});