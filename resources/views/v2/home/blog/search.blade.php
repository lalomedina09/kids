...
<div class="row my-4">
    <form action="{{ route('articles.search.full') }}" method="POST" class="d-flex w-100" id="searchForm">
        ...
        <div class="col-md-12 mt-4 mb-4 d-flex align-items-center position-relative">
            ...
            <!-- Botón de búsqueda -->
            <button class="btn custom-btn" style="height: 43px;" type="submit" id="searchButton">
...
<script>
    ...
    // Limpiar resultados anteriores (ya lo haces, pero por claridad)
    ...
    // Si no hay resultados, opcionalmente mostrar un mensaje
