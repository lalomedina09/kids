...
button1.addEventListener("click", function() {
  ...
  //id random luego cambiar y revisar esta funcion
  const idCurso = @json(100);
    ...
    <div class="container">
        <div class="mt-5">
            <div class="text-center">
                ...
                <h2 class="text-danger text-bold">$ 299 MXN</h2>
            ...
            <form action="" method="" id="form-course" name="form-course" class="form-custom">
                ...
                <input type="hidden" id="promo_id" name="promo_id" value="100"  placeholder="id de la promo">
                @csrf
                    ...
                    <div class="col-xl-8 col-lg-8 col-12 small">
                      <a>Al seleccionar esta opción te redireccionaremos con el LOGIN oficial de PayPal</a>
                        <ul class="list">
                            ...
                            <li>
                                PayPal cobrará una comisión adicional del 3.95% + MXN 4.00
                            </li>
                        </ul>
                    </div>
                </div>
