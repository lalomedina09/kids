<div class="image-background p-5" style="background-image: url(&#39;/images/courses/inversiones-colaboradores/background.png&#39;);">
    <div class="container text-center text-white">
        <section>
            <h1 class="mb-3 pt-3 text-center text-white font-weight-normal title-underline title-underline-b">Nuestra <span class="font-weight-bold">experiencia</span></h1>
            <h2 class="mb-5 pt-3 text-center font-weight-normal">
                Hemos trabajado en capacitación de finanzas<br>
            ...
            <div class="col-12 text-center padding-custom-regis-qdp">
                <a href="#section-form" class="btn btn-pill btn-dark text-uppercase font-weight-bold mb-2">
