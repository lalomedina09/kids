            ...
            <div class="row g-4">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2 class="wow fadeInUp text-orange text-center" data-wow-delay=".3s">
                            ¿Por qué enseñar finanzas desde pequeños?
                        </h2>

                        <p class="mt-4 mt-md-0 wow fadeInUp text-center" data-wow-delay=".5s">
                            Desarrolla habilidades que les permitan administrar <br>
                            mejor su dinero en la adultez.
                        </p>
                    </div>
                </div>
            </div>
