            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-12 mb-3">
                    <div class="p-4 rounded-lg text-center" style="background-color:#FF6161;">
                        <h5 class="text-white text-uppercase">Conoce más sobre nuestras asesorías personalizadas por videollamada</h5>
                    ...
                    <div class="carousel-item text-center active">
                        <div class="row">
                            <div class="col-xl-6 offset-xl-3 col-lg-6 offset-lg-3 col-8 offset-2 py-5">
                                <p>Me explicó muy bien, y fue paciente en mi caso que yo no se mucho o nada del tema que quería aclarar, si recomiendo su asesoría :)</p>
