...
@section('content')
    ...
    <div class="image-background pos-rel landing-jumbo"
        style="background-image: url(/images/landing/advice/bg.jpg);">
            ...
            <div class="row m-0 h-100">
                <div class="col-xl-6 col-lg-6 col-md-6 col-12 h-100">
                    <div class="align-vertical">
                        <div class="mb-3">
                            <h1 class="text-white">Resuelve tus dudas en <span class="text-danger">Finanzas Personales</span></h1>
                        </div>

                        <div class="d-flex flex-row align-items-center mb-2">
                            <img src="{{ asset('images/landing/advice/chk.png') }}" width="40" class="mr-2">
                            <h5 class="text-white mb-0">Crea una estrategia para pagar tus Tarjetas de Crédito</h5>
                        </div>

                        <div class="d-flex flex-row align-items-center mb-2">
                            <img src="{{ asset('images/landing/advice/chk.png') }}" width="40" class="mr-2">
                            <h5 class="text-white mb-0">Decide cuál es la mejor Inversión para el Retiro</h5>
                        </div>

                        <div class="d-flex flex-row align-items-center mb-2">
                            <img src="{{ asset('images/landing/advice/chk.png') }}" width="40" class="mr-2">
                            <h5 class="text-white mb-0">Usa la deuda a tu favor</h5>
                        </div>

                        <div class="d-flex flex-row align-items-center mb-2">
                            <img src="{{ asset('images/landing/advice/chk.png') }}" width="40" class="mr-2">
                            <h5 class="text-white mb-0">Mejora tus Finanzas Personales</h5>
                        </div>

                        <div class="d-flex flex-row align-items-center mb-2">
                            <img class="mr-2" src="{{ asset('images/landing/advice/lc.png') }}" width="70px">
                            <h5 class="text-white text-bold text-uppercase m-0">Garantía de duda resuelta</h5>
                        </div>
                    </div>
                </div>
                            ...
                            <div>
                                ...
                                <div id="mc_embed_signup">
                                    <form action="https://queridodinero.us11.list-manage.com/subscribe/post?u=1b50f97908854fb517fadf05c&amp;id=d20a9efb0d" method="post"
                                        ...
                                        <input type="checkbox" name="group[23489][4]" id="mce-group[23489]-23489-2" value="4" style="display:none;" checked>
            ...
            <div class="my-5">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12 mb-3">
                        ...
                        <h4 class="ml-3 mb-3 text-bold text-uppercase">Elige al coach</h4>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12 mb-3">
                        ...
                        <h4 class="mb-3 text-bold text-uppercase">Califica a tu coach</h4>
            ...
            <div id="advice-testimonies" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item text-center">
                        <div class="col-xl-6 offset-xl-3 col-lg-6 offset-lg-3 col-8 offset-2 py-5">
                            <p>Alfonso me ayudó a despejar muchas dudas y así poder tomar mejores decisiones.</p>
                            <p class="text-danger text-uppercase">Pablo Porras</p>
                        </div>
                    </div>
                </div>
