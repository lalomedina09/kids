...
<div class="container pt-0 pt-lg-4">
    <section class="text-center pb-3">
		<img src="{{ asset('etapa1/landings/hsbc/logos-qdplay-hsbc.png') }}" alt="Logo QD Play" width="350">
	</section>
	<section>
		<div class="row">
			...
			<div class="col-md-6 col-12 text-center text-md-left">
                <h1 class="text-normal">
                    Obtén un <span class="text-bold">20</span>% de
                </h1>
				...
				<div>
                    <p class="">
                        ...
                        <br>
                        <span>* El 20% de descuento solo aplica en la membresia mensual.</span>
                    </p>
				</div>
