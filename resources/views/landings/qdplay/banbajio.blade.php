...
<div class="container pt-0 pt-lg-4">
    <section class="text-center pb-3">
		<img src="{{ asset('etapa1/landings/banbajio/logos-qdplay-banbajio.png') }}" alt="Logo QD Play" width="350">
	</section>
	<section>
		<div class="row">
			<div class="col-md-6 col-12">
				<img src="{{ asset('etapa1/landings/hsbc/ilustracion.png') }}" alt="Logo ilustracion izquierdo" class="w-100" />
			</div>
			<div class="col-md-6 col-12 text-center text-md-left">
                <h1 class="text-normal">
                    Obtén un <span class="text-bold">100</span>% de
                </h1>
				...
				@include('landings.qdplay.components.form')
				...
				<div>
                    <p class="">
                        ...
                        <br>
                        <span>* El 100% de descuento solo aplica en la membresia mensual.</span>
                    </p>
				</div>
