<div id="{{ str_slug(__('Payment')) }}" class="tab-pane">
    ...
    <h5 class="text-danger text-uppercase mb-4 custom-f-s-small">@lang('Banking information')</h5>
    ...
    <form action="{{ route('profile.update', ['payment']) }}" method="post"
        ...
        <div class="form-row mb-3">
            <div class="form-group col-12">
                <label for="user-clabe" class="control-label text-uppercase custom-f-s-small">* @lang('CLABE')</label>
            ...
            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-12">
                <label for="user-bank" class="control-label text-uppercase custom-f-s-small">@lang('Bank')</label>
                <input type="text" id="user-bank" class="form-control" readonly disabled>
            </div>

            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-12">
                <label for="user-account" class="control-label text-uppercase custom-f-s-small">@lang('Account')</label>
                <input type="text" id="user-account" class="form-control" readonly disabled>
            </div>
        </div>

        <!--- Datos Fiscales --->
        <h5 class="text-danger text-uppercase custom-f-s-small my-4">@lang('Tax data')</h5>

        <div class="form-row mb-3">
            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-12">
                <label for="user-tax-name" class="control-label text-uppercase custom-f-s-small">* @lang('Business name')</label>
            ...
            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-12">
                <label for="user-tax-number" class="control-label text-uppercase custom-f-s-small">* @lang('Taxpayer identification number')</label>
            ...
            <!------->
            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-12">
                <label for="user-tax-name" class="control-label text-uppercase custom-f-s-small">* Constancía de Situación Fiscal</label>
            ...
            <!------->
            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-12">
                <label for="user-tax-address" class="control-label text-uppercase custom-f-s-small">* @lang('Street')</label>
            ...
            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-12">
                <label for="user-tax-address-number" class="control-label text-uppercase custom-f-s-small">* @lang('Number')</label>
            ...
            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-12">
                <label for="user-tax-zipcode" class="control-label text-uppercase custom-f-s-small">* @lang('Zip code')</label>
            ...
            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-12">
                <label for="user-tax-settlements" class="control-label text-uppercase custom-f-s-small">* @lang('Settlement')</label>
            ...
            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-12">
                <label class="control-label text-uppercase custom-f-s-small">@lang('Municipality')</label>
                <input type="text" id="user-tax-municipality" class="form-control" readonly disabled>
            </div>

            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-12">
                <label class="control-label text-uppercase custom-f-s-small">@lang('State')</label>
    ...
    @if($user->getmedia('profile_file_tax')->first())
        <hr>
        <h5 class="text-danger text-uppercase custom-f-s-small mb-4">Actualiza tu constancia de situacion fiscal</h5>
        <form action="{{ route('update.situation.tax', [$user]) }}"
            ...
            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-12">
                <label for="profile_file_tax" class="text-dark control-label custom-f-s-small">Subir constancia</label>
                <input type="file" name="profile_file_tax" id="profile_file_tax" accept="pdf"/>
                <small class="form-text text-muted">Máximo 2 MB, en formato PDF</small>

                @if ($errors->has('profile_file_tax'))
                    <span class="small text-danger custom-f-s-small">{{ $errors->first('profile_file_tax') }}</span>
                @endif
            </div>

            <div class="form-group col-12 text-center">
                <input type="submit" value="@lang('Actualizar')" class="btn btn-danger btn-pill custom-f-s-small">
            </div>
        </form>
    @endif
</div>
