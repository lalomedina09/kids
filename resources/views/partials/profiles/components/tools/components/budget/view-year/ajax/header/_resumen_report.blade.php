...
<div class="col-md-4">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <select name="budget_year_report" id="budget_year_report" class="form-control" onchange="changeDateYearReport();" required="required">
...
<div class="col-md-8">
    <div class="row header-bg-gradient">
        <div class="col-md-3">
            <p class="small text-white text-bold mt-2" style="font-size: 1.1rem;">Reporte anual</p>
        </div>
        <div class="col-md-3">
