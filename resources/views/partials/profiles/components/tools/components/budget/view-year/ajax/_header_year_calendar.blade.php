...
<div class="row mt-4">
    <div class="col-md-3 text-left">
        ...
        onclick="activeBudgetSectionYear();">
            Calendario
            <img src="{{ asset('images/tools/budget/calendar-white.png') }}" width="25" alt="Lo que entra">
        </a>
    </div>
    <div class="col-md-3 text-left">
        ...
        onclick="activeBudgetSectionYearReport();">
            ...
            <img src="{{ asset('images/tools/budget/report-black.png') }}" width="25" alt="Lo que sale">
        </a>
    </div>
    <div class="col-md-3 text-left">
