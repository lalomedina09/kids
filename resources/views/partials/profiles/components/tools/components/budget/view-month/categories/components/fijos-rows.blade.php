<div class="row mb-2">
    ...
    <div class="col-md-2 text-center">
        <input type="text" class="form-control custom-input-text" placeholder="Agrega la fecha">
    </div>
    <br>
</div>
...
<div class="row mb-2">
    ...
    <div class="col-md-3 text-center">
        <input type="text" class="form-control custom-input-text custom-input-transparent" placeholder="Agrega el monto real">
    </div>
    <div class="col-md-2 text-center">
        <input type="text" class="form-control custom-input-text custom-input-transparent" placeholder="Agrega la fecha">
    </div>
    <br>
</div>
