        ...
        <div class="text-center">
            @switch($reschedule->status)
                ...
                @case(4)
                    <p class="small mb-1 text-center">
                        <b>¡Buenas noticias!</b>
                        Tu solicitud fue <b>aprobada</b> por tu mentor <span class="text-danger">{{ $advice->advisor->fullname }} </span>
                        para la nueva fecha
                        <span class="text-danger">
                            {{ $advice->present()->given_at }}
                        </span>
                ...
                @case(5)
                    <p class="small mb-1 text-center">
                        <b>¡Malas noticias!</b>
                        Tu solicitud fue <b>rechazada</b> por tu mentor <span class="text-danger">{{ $advice->advisor->fullname }} </span>
                ...
                @case(10)
                    <p class="small mb-1 text-center">
                        Enviaste solicitud de actualiación de calendario a tu mentor
