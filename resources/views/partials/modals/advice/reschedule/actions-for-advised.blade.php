            ...
            @switch($reschedule->status)
                @case(2)
                    <p class="small mb-1 text-center">
                        Tu coach te ofrece <b>Re-agendar</b> la asesoria,<br>
                        elige la nueva fecha desde el botón <b>"Ver solicitud del coach"</b>
                    </p>
                    <br>
                    <a href="{{ route('qd.advice.advice.reschedule.edit', [$advice->hashid]) }}" class="btn btn btn-pill btn-danger mr-5 animated tada">
                        Ver Solicitud del coach
                    </a>
                    @break
                @case(3)
                    <p class="small mb-1 text-center">
                        <b>Re agendaste</b> la asesoria, espera que tu coach <b>acepte</b> o <b>rechace</b>
                        la nueva fecha, Si tu coach <b>no cambia el status</b> tu asesoría se llevará acabo en la nueva fecha que elegiste
                ...
                @case(4)
                    <p class="small mb-1 text-center">
                        <b>¡Buenas noticias!</b>
                        Tu solicitud fue <b>aprobada</b> por tu coach <span class="text-danger">{{ $advice->advisor->fullname }} </span>
                        para la nueva fecha
                        <span class="text-danger">
                            {{ $advice->present()->given_at }}
                        </span>
                ...
                @case(5)
                    <p class="small mb-1 text-center">
                        <b>¡Malas noticias!</b>
                        Tu solicitud fue <b>rechazada</b> por tu coach <span class="text-danger">{{ $advice->advisor->fullname }} </span>
                ...
                @case(7)
                    <p class="small mb-1 text-center">
                        Hola el coach <span class="text-danger">{{ $advice->advisor->fullname }}</span>, <br>
                ...
                @case(10)
                    <p class="small mb-1 text-center">
                        Enviaste solicitud de actualiación de calendario a tu coach
                ...
                @case(11)
                    <p class="small mb-1 text-center">
                        Hola tu coach <span class="text-danger">{{ $advice->advisor->fullname }}</span> , <br>
