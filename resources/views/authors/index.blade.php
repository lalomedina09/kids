            ...
            <div class="row">
                <div class="col-xl-8 offset-xl-2 col-lg-8 offset-lg-2 col-md-10 offset-md-1 col-sm-12 col-12">
                    <div class="align-items-center align-vertical">
                        <h1 class="text-uppercase text-white mb-4">@lang('Writters')</h1>

                        <p class="text-danger text-justify mb-4">
                            Este es el equipo de escritores de Querido Dinero e invitados que comparten experiencias y conocimiento sobre los temas que nos apasionan.
                ...
                <div id="escritores-querido-dinero" class="tab-pane active">
                    <div class="row">
                        @foreach ($staff_authors as $author)
                            @include('partials.authors.card', ['author' => $author])
                        @endforeach
                    </div>
                </div>
