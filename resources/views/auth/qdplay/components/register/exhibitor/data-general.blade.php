                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox mt-1">
                                    <label class="text-uppercase">
                                        <input type="checkbox" name="service_contract" required="required" value="1" checked> Acepto contrato de prestación de servicios
                                        <span class="custom-control-indicator"></span>
                                    </label>
                                </div>
                                <p class="m-0">
                                    <a href="{{ route('privacy') }}" target="_blank" class="text-white text-underline text-small">
                                        Consulta Contrato de prestación de servicios
                                    </a>
                                    <a href="{{ route('privacy') }}" target="_blank" class="text-white text-underline text-small">
