    ...
    <div class="col-xl-6 offset-md-3 col-lg-6 offset-md-3 col-md-6 offset-md-3 col-sm-8 offset-md-2 col-12">
        <div class="p-3" style="background-color: #262525;">
            ...
            @endpush
                ...
                <form action="{{ route('qdplay-login') }}" method="POST"
                    ...
                    <div class="text-center mt-4">
                        <input type="submit" name="submit" value="@lang('Login')" class="btn btn-pill bg-green-blue text-white">
                    </div>
                </form>
                ...
                <div class="text-center">
                    ...
                    <a href="{{ route('register') }}" class="btn btn-pill bg-green-blue text-white">Registrate aquí</a>
                </div>-->
