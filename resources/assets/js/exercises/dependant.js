...
const init = (container_selector) => {
    ...
    const $addButton = document.querySelector('#dependant-answers-add');
    ...
    const addAnswer = () => {
        ...
        insertTemplate('dependant_answer', template_data, container_selector);
        count++;
        last_id++;
    };
    ...
    bindLiveEvent('click', '.dependant-answers-remove', (event, target) => {
        event.preventDefault();
        removeAnswer(target);
